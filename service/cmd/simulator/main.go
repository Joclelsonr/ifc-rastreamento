...
func main() {
	mongoSrt := "mongodb://root:root@localhost:27017/routes?authSource=admin"
	mongoConnection, err := mongo.Connect(context.Background(), options.Client().ApplyURI(mongoSrt))
	if err != nil {
		panic(err)
	}
